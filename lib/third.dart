...
// class Third_Widget extends StatelessWidget {
//   const Third_Widget({super.key});
class Third_Widget extends StatefulWidget {
  const Third_Widget({super.key});

  @override
  _Third_WidgetState createState() => _Third_WidgetState();
}

class _Third_WidgetState extends State<Third_Widget> {
      ...
      body: Column(
        children: [
          Stack(
            children: [
              Container(
                  child: Image.asset('assets/box4.jpg',
          ...
          Padding(
            ...
            child: Stack(
              children: [
                ...
                // Padding(
                //   padding: const EdgeInsets.only(left: 320.0, top: 23),
