...
class Second_Widget extends StatelessWidget {
  const Second_Widget({Key? key}) : super(key: key);
        ...
        child: Column(
          children: [
            ...
            Container(
              ...
              child: TabBar(
                indicatorColor: Color(0xff4B281E),
                labelColor: Color(0xff4B281E),
